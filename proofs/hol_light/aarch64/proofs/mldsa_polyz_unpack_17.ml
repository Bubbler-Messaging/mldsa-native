...
[
  ...
  0x4cdfa820;       (* arm_LDP Q0 Q1 X1 (Postimmediate_Offset (word 32)) *)
  0xbc404422;       (* arm_LDR S2 X1 (Postimmediate_Offset (word 4)) *)
  ...
  0x54fffd21;       (* arm_BNE (word 2097060) *)
...
let MLDSA_POLYZ_UNPACK_17_CORRECT = prove
 (`!r b t l pc.
        LENGTH l = 256 /\
        nonoverlapping (word pc,LENGTH mldsa_polyz_unpack_17_mc) (r,1024) /\
        nonoverlapping (b,576) (r,1024)
        ==> ensures arm
