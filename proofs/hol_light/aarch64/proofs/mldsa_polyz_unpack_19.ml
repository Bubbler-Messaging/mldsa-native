...
[
  ...
  0x4cdfac20;       (* arm_LDP Q0 Q1 X1 (Postimmediate_Offset (word 32)) *)
  0xfc408422;       (* arm_LDR D2 X1 (Postimmediate_Offset (word 8)) *)
...
let MLDSA_POLYZ_UNPACK_19_CORRECT = prove
 (`!r b t l pc.
        LENGTH l = 256 /\
        nonoverlapping (word pc,LENGTH mldsa_polyz_unpack_19_mc) (r,1024) /\
        nonoverlapping (b,640) (r,1024)
        ==> ensures arm
