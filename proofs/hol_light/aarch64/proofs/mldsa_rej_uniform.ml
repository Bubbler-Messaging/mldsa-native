...
needs "aarch64/proofs/mldsa_rej_uniform_table.ml";;

(**** print_literal_from_elf "aarch64/mldsa/mldsa_rej_uniform.o";;
 ****)

let mldsa_rej_uniform_mc = define_assert_from_elf
  "mldsa_rej_uniform_mc" "aarch64/mldsa/mldsa_rej_uniform.o"
(*** BYTECODE START ***)
[
